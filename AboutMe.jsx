      ...
      <div class="flex flex-col md:flex-row md:space-x-12">
        ...
        <p class="text-lg text-gray-300 mb-8 mx-3 md:mx-0">I am a passionate full-stack developer with a focus on building
          ...
          <div class="flex flex-col justify-center items-center">
            <h1 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r  from-green-400 to-blue-500">3+</h1>
            <p class="text-gray-300">Years Experience</p>
          </div>
          <div class="flex flex-col items-center">
            <h1 class="text-2xl font-bold text-transparent bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text">50+</h1>
